...
- **Real-time file watcher system** with background process monitoring
  ...
  - `auto-start-watcher.js` - SessionStart hook integration

- **Alert system integrated with Claude Code Chat**
...
- **Auto-start on Claude Code launch** via SessionStart hook
...
- **Latest Version:** https://github.com/mgbotoe/claude-code-share/tree/main/claude-code-skills/code-refactoring
- **Report Issues:** https://github.com/mgbotoe/claude-code-share/issues
