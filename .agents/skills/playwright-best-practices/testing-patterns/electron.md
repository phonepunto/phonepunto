...
test('launch packaged app', async () => {
  const appPath = process.platform === 'darwin' ? '/Applications/MyApp.app/Contents/MacOS/MyApp' : process.platform === 'win32' ? 'C:\\Program Files\\MyApp\\MyApp.exe' : '/usr/bin/myapp';
